...
df = yf.download(symbol, start='2016-01-01', end=end_date, interval='1d', progress=True, auto_adjust=True, rounding=True)
...
df.to_csv('K:\\git\\Stock Forecaster\\TEST2.csv')

# Save the data to a parquet file
df.to_parquet('K:\\git\\Stock Forecaster\\TEST2.parquet')

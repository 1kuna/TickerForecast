...
for x in range(1,3):
    for i in range(1,13):
        CSV_URL = f'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY_EXTENDED&symbol={ticker}&interval=5min&slice=year{x}month{i}&adjusted=true&apikey=7V18CQ34ZDK1M3SJ'
